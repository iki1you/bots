...
cities = {
    'москва': ['965417/9d558018976476012b3c',
               '1540737/b4e147f9acf9a5eda2b3'],
    'нью-йорк': ['997614/ea4c96185b7a2338d75a',
                 '1652229/70d357d69d9fdb864c6a'],
    'париж': ["1540737/0e3c64c545aa16ff56e3",
              '1652229/f23365583988181649df']
}
...
def handle_dialog(res, req):
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if 'помощь' in req['request']['nlu']['tokens']:
            res['response']['text'] = 'Алиса показывает пользователю фотографию города, а он должен его отгадать.\n' \
                                      'Важный момент: перед игрой пользователь должен представиться'
    ...
    if attempt == 1:
        ...
        if get_city(req) == city:
            ...
            if attempt == 3:
                ...
                if 'помощь' in req['request']['nlu']['tokens']:
                    res['response'][
                        'text'] = 'Алиса показывает пользователю фотографию города, а он должен его отгадать.\n' \
                                  'Важный момент: перед игрой пользователь должен представиться'
                    return
